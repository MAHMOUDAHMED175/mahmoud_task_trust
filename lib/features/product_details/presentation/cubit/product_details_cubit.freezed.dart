...
mixin _$ProductDetailsState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(ProductEntity product, List<AddonEntity> addons)
        loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(ProductEntity product, List<AddonEntity> addons)? loaded,
...
abstract class _$$LoadedImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({ProductEntity product, List<AddonEntity> addons});
}
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(
      {required this.product, required final List<AddonEntity> addons})
      : _addons = addons;
  ...
  @override
  String toString() {
    return 'ProductDetailsState.loaded(product: $product, addons: $addons)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, product, const DeepCollectionEquality().hash(_addons));
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return loaded?.call(product, addons);
  }
...
abstract class _Loaded implements ProductDetailsState {
  const factory _Loaded(
      ...
      required final List<AddonEntity> addons}) = _$LoadedImpl;
